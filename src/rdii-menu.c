...
static const char *main_menu_help_text =
  ...
  "- If the kernel command line (/proc/cmdline) contains rdii.config=<url>, rdii-fetch-config downloads the configuration from that URL instead, taking precedence over the boot source location.\n\n"
